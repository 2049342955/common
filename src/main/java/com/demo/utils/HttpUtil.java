package com.demo.utils;//package com.esudian.utils;
//
...
//
//        LOGGER.debug("url is {},method is {},paramMap is {}", new Object[]{
//                url, method, paramMap});
...
//                LOGGER.error("statusCode is {},paramMap is {}", new Object[]{
//                        statusCode, paramMap});
...
//            }
//        } catch (Exception e) {
//            LOGGER.error("paras is {},exception is {}", new Object[]{
//                    paramMap, e});
//        } finally {
//            // 释放连接
...
//            gettMethod = new GetMethod(uri.toString());
//            gettMethod.setRequestHeader("Connection", "close");
//            gettMethod.setRequestHeader("Content-type",
...
//        } catch (Exception e) {
//            LOGGER.error(
//                    "HttpGetByUtf url is {},method is {},paramMap is {},exception is {}",
...
//     */
//    @SuppressWarnings({"rawtypes", "unchecked"})
//    public static String HttpGetByUtfNoMenthod(String url, String method,
//                                               Map paramMap) {
//        // 设置编码格式
//        String encoding = "UTF-8";
//        String webUrl = url + "/" + method;
...
//        LOGGER.debug("doGet url is {}", new Object[]{url});
...
//            httpClientNew.getHttpConnectionManager().getParams()
//                    .setConnectionTimeout(50000); // 连接5秒超时
//            httpClientNew.getHttpConnectionManager().getParams()
//                    .setSoTimeout(70000);// 读取30秒超时
//            httpClientNew.executeMethod(method);
//            // if (method.getStatusCode() == HttpStatus.SC_OK) {
//            response = method.getResponseBodyAsString();
//        } catch (Exception e) {
//            LOGGER.error("url is {},Exception is {}",
//                    new Object[]{url, e.getMessage()});
//        } finally {
//            method.releaseConnection();
//        }
//        LOGGER.debug("url is {},response is {}",
...
//        LOGGER.debug("doPostFormData url is {},parajson is {}", new Object[]{url,
//                params});
//        String response = null;
//        PostMethod method = new PostMethod(url);
...
//        } catch (Exception e) {
//            LOGGER.error("url is {},parajson is {},Exception is {}",
//                    new Object[]{url, params, e.getMessage()});
//        } finally {
//            method.releaseConnection();
//        }
//        LOGGER.debug("url is {},parajsonjson is {},response is {}",
//                new Object[]{url, params, response});
//        return response;
//
//
//    }
...
// * JSONObject
// */
//// public static JSONObject HttpGetRequest(HttpServletRequest request)
//// throws IOException {
